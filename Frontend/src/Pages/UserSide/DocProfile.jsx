                    ...
                    <div className="col-span-4 sm:col-span-3">
                        <div className="bg-white shadow rounded-lg p-6">
                            <div className="flex flex-col items-center">
                                <img
                                    src={doct.user ? doct.user.profile_picture ? doct.user.profile_picture : UserImage : UserImage}
                            ...
                            {showBooking && <div className="flex flex-col overflow-x-scroll">
                                <DoctorAvailability fees={doct.consultation_fees} doctorId={doct.id} patient_id={patient_id} />
                            </div>}
                        </div>
                    </div>

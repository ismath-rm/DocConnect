            ...
            <div className="text-white pt-2" style={{ fontFamily: 'Arial, sans-serif' }}>
                <div className="max-w-8xl ">
                    <div className="text-center relative ">
                        <img src={Banner6} alt="Online Doctor Booking Banner" className="w-full h-96 object-cover rounded-lg" />
                    ...
                    <div className="text-center mt-16">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Link to='/'>
                                <Button className='lg:w-60 lg:h-14 rounded-full py-2 px-4 text-white font-bold bg-blue-500'>Book an Appointment</Button>
                            </Link>
                        </div>
                    </div>

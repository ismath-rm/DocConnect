            ...
            <div className="text-white pt-2" style={{ fontFamily: 'Arial, sans-serif' }}>
                <div className="max-w-8xl ">
                    <div className="text-center relative ">
                        <img src={Banner1} alt="Online Doctor Booking Banner" className="w-full h-96 object-cover rounded-lg" />
                    ...
                    <div className="text-center mt-16">
                        <div className="max-w-3xl mx-auto">
                            ...
                            <Link to='/doctor/doctorHome'>
                                <Button className='lg:w-60 lg:h-14 rounded-full py-2 px-4 text-white font-bold bg-blue-500'>Create Slot</Button>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 text-center mb-10">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            <div className="bg-gray-300 py-8 rounded-lg hover:shadow-2xl hover:border-red-500 transition duration-300 ease-in-out transform">

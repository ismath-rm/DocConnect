  ...
  return (
    <div className="flex flex-col items-center space-y-8 justify-center min-h-screen py-6 sm:px-6 lg:px-8">
      <form className="form" onSubmit={handleSubmit}>
        <p className="text-3xl text-blue-600 font-bold text-center">Doctor Register</p>
        ...
        <div className="mt-2 text-center text-sm text-black">
          ...
          <Link to="/auth/doctor/login" className="font-medium text-blue-600 hover:text-blue-200">Login</Link>
        </div>
      </form>

...
const HowItWorksSection = () => {
    return (
        <section className="py-12 bg-gray-200 mb-1">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row md:justify-between space-y-8 md:space-y-0">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex items-center justify-center w-16 h-16 bg-cyan-500  text-white rounded-full mb-4 border-4 border-cyan-950">
                            <svg
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-semibold text-blue-600 mb-2">Book</h3>
                        <p className="text-black text-center">

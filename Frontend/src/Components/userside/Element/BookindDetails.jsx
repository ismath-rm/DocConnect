...
function BookingDetails({ transaction_id }) {
  ...
  useEffect(() => {
    ...
    UserAPIwithAcess
      ...
      .then((res) => {
        ...
        console.log('transactionData in booking details:', transactionData);
        setTransaction(transactionData);

        console.log("Doctor_ID is :", transactionData.doctor_id);
        UserAPIwithAcess
  ...
  const handleCancel = () => {
    console.log('cancel booking:', transaction_id);
    UserAPIwithAcess
      .post(
        ...
        <div className="flex space-x-4 xl:mb-4 2xl:mb-0">
          <div>
            <img
              ...
              src={
                doctor?.user?.profile_picture || UserImage
              }
              alt="Doctor image"
            />
          </div>
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
              ...
              <div className="p-6 pt-0 text-center">
                ...
                <p className="text-red-500">
                  ₹50 will be deducted from your refund amount
                </p>
                <button

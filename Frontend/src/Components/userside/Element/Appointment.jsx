    ...
    <div className="flex flex-col gap-8 p-10">
      <header className="items-center self-stretch flex w-full flex-col justify-center px-16 max-md:max-w-full max-md:px-5">
        <span className="flex flex-col items-center max-md:max-w-full">
          <h1 className="text-black text-center text-2xl font-medium leading-8 max-md:max-w-full">
            Discover the Online Appointment!
          </h1>
          <p className="text-black text-center text-base leading-6 self-stretch mt-4 max-md:max-w-full">
        ...
        <Link to='#'>
          <div class="duration-1000 flex flex-col justify-center items-center w-full transform hover:scale-x-110 hover:scale-y-110 lg:mt-6 text-gray-700 bg-gray-200 shadow-md bg-clip-border rounded-xl xl:w-96">
            <div class="p-6 text-center">
              ...
              <div className="text-black text-base leading-6 mt-2 max-md:max-w-full">
      ...
      <div className="flex items-center justify-center">
        <button className=" bg-blue-600 text-wrap  w-40 h-14  text-white  font-semibold rounded-2xl transform hover:scale-x-110 hover:scale-y-110 hover:bg-gradient-to-r from-teal-500 to-blue-500 transition-all duration-500">
          Find Doctor
        </button>
      </div>
      </Link>

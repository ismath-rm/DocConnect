...
const DoctorContainer = ({ selectedFilters }) => {
    ...
    const fetchUsers = () => {
        ...
        const apiUrl = `${BASE_URL}appointment/doctors/listing/?search=${searchQuery}${genderFilterParam}${specializationFilterParam}`;
                ...
                {doctorData.map((data, key) => (
                    <li key={key}>
                        <DoctorCard
                            ...
                            img={data.profile_picture ? data.profile_picture : UserImage}
                            id={data.doctor_user.id}
                        />
                    </li>
                ))}
            </ul>
